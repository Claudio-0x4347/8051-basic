...
V2:	MOV A, R7			; move o conteudo do registrador 7 para o acumulador
	...
	CJNE R7,#04H, V2		; compara o valor do registrador 7 com o literal 04H, desvia 					o fluxo para V2 se forem diferentes, continua o fluxo se 						forem iguais
...
TABELA:	DB 03H, 06H, 0CH, 09H		; cria uma tabela no final do programa na memória ROM
